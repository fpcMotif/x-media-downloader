...
/** Decide the dev-convenience Convex pre-seed (ADR-0009). Returns the settings patch,
 ...
 *  the import.meta.env.DEV guard and the env reads — the secret literal must stay at the
