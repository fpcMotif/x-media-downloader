...
function OnPageControlsGroup({ settings, update }: PanelProps) {
  return (
    <SettingGroup
...
function AdvancedGroup({ settings, update }: PanelProps) {
  return (
    <SettingGroup
      title="Advanced"
...
export function GeneralPanel({ settings, update, reload }: PanelProps) {
  return (
    <>
      <PanelHeader
        title="General"
      ...
      <OnPageControlsGroup settings={settings} update={update} reload={reload} />
      <AdvancedGroup settings={settings} update={update} reload={reload} />
    </>
  )
}
