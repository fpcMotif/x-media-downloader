...
function SaveDefaultsGroup({ settings, update }: PanelProps) {
  return (
    <SettingGroup
      title="Save defaults"
...
function SpeedGroup({ settings, update }: PanelProps) {
  return (
    <SettingGroup
      title="Speed"
...
function DownloadModeGroup({ settings, update }: PanelProps) {
...
export function DownloadsPanel({ settings, update, reload }: PanelProps) {
  return (
    <>
      <PanelHeader title="Downloads" description="How files are named, fetched, and saved." />
      <SaveDefaultsGroup settings={settings} update={update} reload={reload} />
      <SpeedGroup settings={settings} update={update} reload={reload} />
      <DownloadModeGroup settings={settings} update={update} reload={reload} />
    </>
  )
}
