...
describe('isGraphqlMediaUrl', () => {
  ...
  it('matches list timeline GraphQL operations', () => {
    expect(
      isGraphqlMediaUrl(
        'https://x.com/i/api/graphql/abc/ListLatestTweetsTimeline?variables=%7B%22listId%22%3A%221835397961704255789%22%7D',
      ),
    ).toBe(true)
